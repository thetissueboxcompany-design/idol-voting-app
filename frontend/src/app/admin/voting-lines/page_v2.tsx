...
export default function VotingLinesPage() {
  ...
  // HIGHLIGHT: State for contestants
  ...
  // HIGHLIGHT: Function to fetch all contestants
  ...
  useEffect(() => {
    fetchLines();
    fetchContestants(); // Fetch contestants on load
  }, []);
    ...
    try {
      ...
      await axios.post(
        apiUrl,
        {
          ...
          contestant_ids: Array.from(selectedContestants) // Convert Set to Array
        },
        { headers: { Authorization: `Bearer ${token}` } }
      );
      fetchLines();
      ...
      setEndTime('');
      setMaxVotes('50');
      setSelectedContestants(new Set()); // Clear selection
    } catch (err) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="md:col-span-1">
          ...
          <form onSubmit={handleSubmit} className="p-4 bg-gray-800 rounded-lg space-y-4">
            ...
            {/* HIGHLIGHT: Contestant selection checkboxes */}
            <div>
