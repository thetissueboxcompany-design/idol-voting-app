...
import { Heart, LogOut, History } from 'lucide-react'; // Import History icon
  ...
  return (
    <div className="container mx-auto p-4 md:p-8">
      <header className="flex justify-between items-start mb-8">
        ...
        {/* HIGHLIGHT: Updated header with History link */}
        <div className="flex items-center space-x-4">
            <Link href="/history" className="flex items-center space-x-2 px-4 py-2 rounded-md text-gray-300 bg-gray-800 hover:bg-blue-700 hover:text-white" title="View Vote History">
                <History size={20} />
                <span>History</span>
            </Link>
            <button
